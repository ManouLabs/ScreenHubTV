...
// Device ID is generated by the server during onboarding
...
function onFormSubmit() {
    ...
    useScreenService
        ...
        .then((resp) => {
            ...
            screenStore.setLocation(record.value.location_id);
            screenStore.setGroup(record.value.group_id);
            screenStore.setScreenNumber(record.value.screen_number);
